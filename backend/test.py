...
if __name__ == "__main__":
    ...
    num_chunks = crag_service.ingest_documents("./demo_data")
    print(f"Ingested {num_chunks} chunks from documents.")
    
    # Process a query
    response, sources, debug_info = crag_service.process_query("Explain me Agents?")
    print(f"Response: {response}")
    print(f"Sources: {sources}")
    print(f"Debug Info: {debug_info}")
    
    # Get chat history
    chat_history = crag_service.get_chat_history()
    print(f"Chat History: {chat_history}")
    
    # Clear memory
    crag_service.clear_memory()
